...
WebUI.setText(findTestObject('Page_Welcome to BUKIWEB/InputChargeNONWO'), InputChargeNONWO)

WebUI.setText(findTestObject('Page_Welcome to BUKIWEB/InputRetailNONWO'), InputRetailNONWO)

WebUI.setText(findTestObject('Page_Welcome to BUKIWEB/InputHandlingfeeNONWO'), InputHandlingFeeNONWO)

WebUI.setText(findTestObject('Page_Welcome to BUKIWEB/InputCashNONWO'), InputCashNONWO)

WebUI.scrollToElement(findTestObject('Page_Welcome to BUKIWEB/InputChargeNONWO'), 0)
